...
const products: Product[] = [
  ...
  { id: 2, name: "Modern Black Stool", image: "/Image(1).png", badge: "sale", price:25 },
  {
    id: 3,
  ...
  { id: 6, name: "Modern Black Stool", image: "/Image(6).png", badge: "sale", price:25 },
  {
    id: 7,
    name: "Vintage Wooden Chair",
    image: "/Image(7).png",
  ...
  { id: 8, name: "Ergonomic Office Chair", image: "/Image(8).png", price:35},
];
