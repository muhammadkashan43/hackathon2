...
const Footer = () => {
  return (
    <footer className="container max-w-[1341px] mx-auto px-4 py-16">
...
<rect width="40" height="40" fill="white"/>
        ...
        <div className="text-center md:text-start">
          <h3 className="font-semibold mb-4 text-gray-900 uppercase  text-sm">Category</h3>
        ...
        {/* Support Section */}
        <div className="text-center md:text-start">
          <h3 className="font-semibold mb-4 text-gray-900 uppercase text-sm">Support</h3>
          <ul className="space-y-2">
        ...
        <div className="justify-center md:justify-start">
          <h3 className="font-semibold mb-4 text-gray-900 uppercase text-sm">Newsletter</h3>
          <div className="space-y-4">
            <textarea
              ...
              className="bg-white"
            />
            <Button className="w-full bg-teal-500 hover:bg-[#0ce1b4] rounded-lg text-black">
              Subscribe
            </Button> 
            <p className="text-gray-600 text-sm">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nullam tincidunt erat enim.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-200">
        <p className="text-sm text-gray-600">
          ...
          <Link href="#" className="text-[#0df2c2]">
            Zokrsoft
          </Link>
        </p>
